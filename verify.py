...
def check_content_signatures():
    ...
    checks = {
        ...
        "urls.py": ["PingView", "TriageView", "StatsView", "FunnelView", "TimelineView", "ChannelsView", "UploadImageView", "UploadImagesView", "app_name"],
        "views.py": ["APIView", "IsAuthenticated", "PingView", "TriageView", "StatsView", "FunnelView", "TimelineView", "ChannelsView", "UploadImageView", "UploadImagesView"],
    }
...
def check_view_endpoints():
    ...
    classes_expected = ["PingView", "TriageView", "StatsView", "FunnelView", "TimelineView", "ChannelsView", "UploadImageView", "UploadImagesView"]
    errors = []
...
def check_urls_endpoints():
    ...
    routes_expected = ["ping/$", "triage/$", "stats/$", "chart/funnel/$", "chart/timeline/$", "chart/channels/$", "upload_image/$", "upload_images/$"]
    errors = []
